...
//    float b = cos((10.0 * uTime + vPos.y) / 7.0) + sin((50.0 * uTime + vPos.z) / 11.0);
    ...
    float r = (1.0 + sin(vPos.z / 99.0 + xy / 99.0 * vPos.z / 100000.0)) / 2.0;
    float g = (1.0 + sin(vPos.z / 101.0 + xy / 101.0 * vPos.z / 100000.0)) / 2.0;
    float b = (1.0 + sin(vPos.z / 103.0 + xy / 103.0 * vPos.z / 100000.0)) / 2.0;
